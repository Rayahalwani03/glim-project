          ...
          <div className="text-left px-6  ">
            ...
            <p
              className="mt-4 
                ...
                text-white"
            >
              Discover the areas where we work and see how your support has made
              a lasting difference—transforming lives through food, education,
              and empowerment across the globe.
            </p>
            <FindOutButton
